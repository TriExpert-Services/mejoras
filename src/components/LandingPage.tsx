        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-900 p-4 pt-20">
          <div className="relative w-full max-w-md">
            ...
            {authMode === 'login' ? (
              ...
              <SignupForm
                onSuccess={() => {
                  // Aquí se enviaría el correo con los datos de acceso
                  // al servidor VPS de prueba
          ...
          <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                ...
                tecnología Avanzada. Prueba gratis por <span className="text-green-400 font-semibold">7 días sin tarjeta</span>.
              </p>
          ...
          <section id="planes" className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                {productsLoading ? (
                  ...
                  <>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-green-500 relative">
                      ...
                      <h3 className="text-xl font-bold mb-2">Plan de Prueba</h3>
                      <p className="text-3xl font-bold text-green-600 mb-4">
                        $0.00
                        <span className="text-lg text-gray-500">/7 días</span>
                      </p>
                      <p className="text-gray-600 mb-4">Sin tarjeta de crédito requerida</p>
                      <ul className="text-sm text-gray-600 space-y-2 mb-6">
                        <li>✓ 1 vCPU</li>
                        <li>✓ 1 GB RAM</li>
                        <li>✓ 20 GB SSD</li>
                        <li>✓ 1 TB Transferencia</li>
                        <li>✓ Acceso Root Completo</li>
                        <li>✓ Soporte 24/7</li>
                      </ul>
                      <Button
              ...
              <p className="text-gray-500 mb-6">
                * Al registrarte, recibirás un correo electrónico con los datos de acceso a tu VPS de prueba en menos de 5 minutos.
              </p>
          ...
          <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Prueba nuestro servicio gratis por 7 días sin compromiso
              </p>
